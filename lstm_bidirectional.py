...
#build model - bidirectional LSTM layer, LSTM, 20% dropout twice, flatten then dense
model=Sequential()
...
model.compile(loss='binary_crossentropy',
	optimizer=opt,
	metrics=['accuracy'])
# fit model with batch size = 250, 2 epochs
history = model.fit(x_train, y_train, epochs=10, validation_data=(x_test, y_test),verbose=1,batch_size=900)
#save model
model.save('my_model_bidirectional.h5')
